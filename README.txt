TITLE: 
Customer Records and Scheduling Appointments Database

PURPOSE: 
The purpose of this application is to assist an organization with a GUI-based scheduling desktop application.
The application will be able to update, add, and delete customer records and appointments.
The organization does business in multiple languages and in different locations in the United States, Candada, and
